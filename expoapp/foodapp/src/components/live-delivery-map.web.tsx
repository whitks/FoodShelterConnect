...
import { Bike, CheckCircle2, HeartHandshake, MapPin } from 'lucide-react-native';
...
const SHELTERS = [
  ...
  { id: 's3', name: 'Sunshine Foundation', latitude: 12.995, longitude: 77.57 },
  { id: 's4', name: 'Green Hope NGO', latitude: 12.961, longitude: 77.641 },
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.webMapPlaceholder}>
        ...
        <Text style={styles.webSub}>
          {distKm.toFixed(1)} km · ETA ~{etaMin} min
        </Text>
